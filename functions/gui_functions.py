...
def populate_fields(self):
    ...
    dataset = self.dataset_information[self.sender().text()]
    ...
    for field in fields:
        ...
        self.field_rb[field_num].clicked.connect(lambda: populate_parameters(self, dataset))
...
def populate_parameters(self, dataset):
    ...
    for parameter in parameters:
        ...
        self.parameter_cb[param_num].clicked.connect(lambda: populate_times(self, dataset, field, parameters_dict))
...
def clear_period_widgets(self):
    ...
    self.time_gb_1.setExclusive(False)
    self.time_rb_1.setChecked(False)
    self.time_rb_2.setChecked(False)
    self.time_gb_1.setExclusive(True)
...
def show_area_map(self):
    ...
    if self.area_vertical_layout.count() == 0:
        ...
        spacerItem38 = QtWidgets.QSpacerItem(230, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_11.addItem(spacerItem38)
        self.area_lb_4 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        ...
        spacerItem39 = QtWidgets.QSpacerItem(688, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem40 = QtWidgets.QSpacerItem(43, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.verticalLayout_28.addItem(spacerItem45)
        ...
        spacerItem49 = QtWidgets.QSpacerItem(188, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
